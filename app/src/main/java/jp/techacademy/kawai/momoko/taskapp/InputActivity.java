...
public class InputActivity extends AppCompatActivity {
    ...
    private Button mSelectButton, mDateButton, mTimeButton;
    private EditText mTitleEdit, mCategoryEdit, mContentEdit;
    private Task mTask;
    List<String> mCategoryList = new ArrayList<>();

    private View.OnClickListener mOnSelClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            builder.setItems( items, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    mCategoryEdit.setText(mCategoryList.get(which));
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectButton.setOnClickListener(mOnSelClickListener);
        ...
        realm.close();
        mCategoryList= Arrays.asList(intent.getStringArrayExtra(MainActivity.EXTRA_CATEGORY));
        mCategoryList = mCategoryList.subList(1,mCategoryList.size());
